                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>wananalyst/menu_list_permintaan_srv" class="sidebar-active"><i class="fa fa-edit fa-fw"></i> Survey</a>
                            </li>
                            <li>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $count = 0; foreach ($list_permintaan as $row) : $count++;?>
                                <form method="POST" action="<?php echo base_url('wananalyst/survey')?>">
                                <tr>
