        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>wanengineer/menu_list_permintaan" class="sidebar-active"><i class="fa fa-edit fa-fw"></i> UAT <span class="badge pull-right"><?php echo $count_uat?></span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">UAT yang perlu dilakukan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <div class="row">
                    ...
                    <form id="myform" method="POST" action="<?php echo base_url('wanengineer/uat')?>">
